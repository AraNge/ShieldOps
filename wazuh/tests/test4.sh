...
docker run --rm alpine echo "Wazuh Test 2"
sleep 3


# 1. Проверяем, видит ли менеджер агента в режиме Active
...
# 2. Проверяем, работает ли модуль docker-listener на агенте
...
# 3. Генерируем тестовое событие Docker
...
# Ищем ключевое слово alpine в архиве логов
